    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                node note = new node(edtTitle.getText().toString(), edtDescription.getText().toString());
                note.setId(intent.getIntExtra("id",1));
                if (new notehandler(edit_note.this).update(note)){
                    Toast.makeText(edit_note.this, "Note updated", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(edit_note.this, "Failed updating", Toast.LENGTH_SHORT).show();
                }
                onBackPressed();
            }
        });
